...
config.development = {
  ...
  db: {
    ...
    password: process.env.RDS_PASSWORD || "177581",
  ...
  local: {
    ...
    storageDir: process.env.STORAGE_DIR || "/Users/lihaitao/Desktop/workspaces/storage",
  ...
  common: {
    ...
    dataDir: process.env.DATA_DIR || "/Users/lihaitao/Desktop/workspaces/data",
